...
/// in the trainer registration step three form.
class StepThreeNextBackButton extends ConsumerWidget {
  /// Creates a [StepThreeNextBackButton] widget.
  ///
  const StepThreeNextBackButton({super.key, this.onNext, this.onBack});
