...
/// Use case for registering a new trainer.
class RegisterTrainerUserCase {
  /// Creates an instance with the given [trainerRepository].
  RegisterTrainerUserCase({required this.trainerRepository});

  /// Repository to handle trainer registration logic.
  final TrainerRepository trainerRepository;

  /// Executes the use case to register a trainer.
  Future<Either<Failure, TrainerEntity>> call(
    ...
    final String lowerCasePath = certificate.path.toLowerCase();
    ...
    final int fileSizeInBytes = await certificate
    ...
    return trainerRepository.registerTrainer(
      trainer,
      certificate,
      password,
    );
